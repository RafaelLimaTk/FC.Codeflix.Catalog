...
public class CreateVideo : ICreateVideo
{
    ...
    private async Task UploadImagesMedia(CreateVideoRequest input, DomainEntities.Video video, CancellationToken cancellationToken)
    {
    ...
    private async Task UploadVideosMedia(CreateVideoRequest input, DomainEntities.Video video, CancellationToken cancellationToken)
    {
    ...
    private async Task ValidateAndAddRelations(CreateVideoRequest input, DomainEntities.Video video, CancellationToken cancellationToken)
    {
    ...
    private async Task ValidateCastMembersIds(CreateVideoRequest input, CancellationToken cancellationToken)
    {
    ...
    private async Task ValidateGenresIds(CreateVideoRequest input, CancellationToken cancellationToken)
    {
    ...
    private async Task ValidateCategoriesIds(CreateVideoRequest input, CancellationToken cancellationToken)
    {
