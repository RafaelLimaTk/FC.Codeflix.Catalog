...
public class GenreRepositoryTest
{
    ...
    public async Task SearchReturnsItemsAndTotal()
    {
        ...
        var searchInput = new SearchRequest(1, 20, "", "", SearchOrder.Asc);
    ...
    )
    {
        ...
        var searchInput = new SearchRequest(page, perPage, "", "", SearchOrder.Asc);
    ...
    )
    {
        ...
        var searchInput = new SearchRequest(page, perPage, search, "", SearchOrder.Asc);
    ...
    )
    {
        ...
        var searchInput = new SearchRequest(1, 20, "", orderBy, searchOrder);
