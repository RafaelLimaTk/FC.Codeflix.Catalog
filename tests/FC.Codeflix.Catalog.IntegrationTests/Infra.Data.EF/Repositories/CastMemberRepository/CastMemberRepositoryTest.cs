...
public class CastMemberRepositoryTest
{
    ...
    public async Task Search()
    {
        ...
        var searchResult = await castMembersRepository.Search(
            new SearchRequest(1, 20, "", "", SearchOrder.Asc),
            CancellationToken.None
        );
    ...
    )
    {
        ...
        var searchResult = await castMembersRepository.Search(
            new SearchRequest(page, perPage, "", "", SearchOrder.Asc),
            CancellationToken.None
        );
    ...
    )
    {
        ...
        var searchResult = await castMembersRepository.Search(
            new SearchRequest(page, perPage, search, "", SearchOrder.Asc),
            CancellationToken.None
        );
    ...
    )
    {
        ...
        var searchResult = await castMembersRepository.Search(
            new SearchRequest(1, 10, "", orderBy, inputOrder),
            CancellationToken.None
        );
