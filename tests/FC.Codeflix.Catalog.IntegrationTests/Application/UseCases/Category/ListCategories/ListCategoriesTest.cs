...
public class ListCategoriesTest
{
    ...
    public async Task SearchRetursListAndTotal()
    {
        ...
        var input = new ListCategoriesRequest(1, 20);
        ...
        foreach (CategoryModelResponse outputItem in output.Items)
        {
...
)
    {
        ...
        await dbContext.SaveChangesAsync(CancellationToken.None);
        var categoryRepository = new CategoryRepository(dbContext);
        var input = new ListCategoriesRequest(page, perPage, search);
        var useCase = new ApplicationUseCases.ListCategories(
            categoryRepository
        );
...
)
    {
        ...
        var input = new ListCategoriesRequest(1, 20, "", orderBy, useCaseOrder);
        var useCase = new ApplicationUseCases.ListCategories(
            categoryRepository
        );
