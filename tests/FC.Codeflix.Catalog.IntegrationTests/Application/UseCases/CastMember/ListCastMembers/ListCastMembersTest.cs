...
public class ListCastMembersTest
{
    ...
    )
    {
        ...
        var repository = new CastMemberRepository(_fixture.CreateDbContext(true));
        var useCase = new UseCase.ListCastMembers(repository);
        var input = new UseCase.ListCastMembersRequest(page, perPage, "", "", SearchOrder.Asc);
    ...
    )
    {
        ...
        var repository = new CastMemberRepository(_fixture.CreateDbContext(true));
        var useCase = new UseCase.ListCastMembers(repository);
        var input = new UseCase.ListCastMembersRequest(page, perPage, search, "", SearchOrder.Asc);
    ...
    )
    {
        ...
        var useCase = new UseCase.ListCastMembers(repository);
        var input = new UseCase.ListCastMembersRequest(1, 20, "", orderBy, searchOrder);
