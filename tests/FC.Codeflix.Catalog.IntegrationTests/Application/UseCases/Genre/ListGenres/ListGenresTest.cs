...
public class ListGenresTest
{
    ...
    )
    {
        ...
        UseCase.ListGenresRequest input = new UseCase.ListGenresRequest(page, perPage);
    ...
    )
    {
        ...
        UseCase.ListGenresRequest input = new UseCase.ListGenresRequest(page, perPage, search);
    ...
    )
    {
        ...
        UseCase.ListGenresRequest input = new UseCase.ListGenresRequest(
