...
public class ListCastMembersApiTest : IDisposable
{
    ...
    public async Task List()
    {
        ...
        var (response, output) =
            await _fixture.ApiClient.Get<TestApiResponseList<CastMemberModelResponse>>(
                "cast_members"
            );
...
)
    {
        ...
        var (response, output) =
            await _fixture.ApiClient.Get<TestApiResponseList<CastMemberModelResponse>>(
                "cast_members", new ListCastMembersRequest() { Page = page, PerPage = perPage }
            );
