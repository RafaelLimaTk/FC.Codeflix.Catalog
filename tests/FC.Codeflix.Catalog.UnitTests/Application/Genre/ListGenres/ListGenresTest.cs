...
public class ListGenresTest
{
    ...
    public async Task ListGenres()
    {
        ...
        var outputRepositorySearch = new SearchResponse<DomainEntity.Genre>(
        ...
        UseCase.ListGenresResponse output =
        ...
        ((List<GenreModelResponse>)output.Items).ForEach(outputItem =>
        {
        ...
        genreRepositoryMock.Verify(
            x => x.Search(
                It.Is<SearchRequest>(searchInput =>
    ...
    public async Task ListUsingDefaultInputValues()
    {
        ...
        UseCase.ListGenresResponse output =
            await useCase.Handle(new UseCase.ListGenresRequest(), CancellationToken.None);
