...
public class GetCastMemberTest
{
    ...
    public async Task GetCastMember()
    {
        ...
        var input = new UseCase.GetCastMemberRequest(castMemberExample.Id);
        var useCase = new UseCase.GetCastMember(repositoryMock.Object);

        CastMemberModelResponse output = await useCase.Handle(input, CancellationToken.None);
    ...
    public async Task ThrowIfNotFound()
    {
        ...
        var input = new UseCase.GetCastMemberRequest(Guid.NewGuid());
        var useCase = new UseCase.GetCastMember(repositoryMock.Object);
